...
// Brand palette (mirrors tailwind `royal-*` tokens but baked in because pdfkit
// doesn't read CSS).
const BRAND = {
  primary: "#6366F1", // Indigo
  primaryDark: "#4338CA", // Indigo-700
  ink: "#040408", // match royal-bg
  text: "#1e1e3a", // slate-800
...
function renderPdf(order: {
  ...
  return new Promise((resolve, reject) => {
    ...
    // Brand lockup
    doc.fillColor(BRAND.primary).font("Helvetica-Bold").fontSize(26).text("TY KHAI", marginX, 44);
    const brandW = doc.widthOfString("TY KHAI");
    doc
      .fillColor("#ffffff")
      .fontSize(26)
    ...
    doc.fillColor("#94a3b8").fontSize(8).text("support via Telegram", marginX, 90);
    // INVOICE title right
    doc
      .fillColor("#ffffff")
      .font("Helvetica-Bold")
    ...
    doc
      ...
      .font("Helvetica-Bold")
      .fontSize(9)
      .text("Telegram Support", marginX, footerY + 78);
    doc
      .fillColor("#94a3b8")
      .font("Helvetica")
      .fontSize(8)
